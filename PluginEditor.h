...
git test
*/
class DistortionVstbyMeAudioProcessorEditor  : public AudioProcessorEditor
{
public:
    DistortionVstbyMeAudioProcessorEditor (DistortionVstbyMeAudioProcessor&);
    ~DistortionVstbyMeAudioProcessorEditor();
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (DistortionVstbyMeAudioProcessorEditor)
};
